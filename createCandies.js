...
function createCandy(path, img, xScale, yScale) {
...
function createRoundCandy(radius, img, xScale, yScale) {
...
let sweetCandy = function () {
  return createRoundCandy(25, "../candy-sweet.png", 0.1, 0.1);
};
let pokemonCandy = function () {
  return createRoundCandy(20, "../candy-pokemon.png", 0.2, 0.2);
};
let pappermintBlue = function () {
  return createRoundCandy(25, "../pappermint-blue.png", 0.08, 0.08);
};
let pappermintGreen = function () {
  return createRoundCandy(25, "../pappermint-green.png", 0.08, 0.08);
};
let pappermintPink = function () {
  return createRoundCandy(25, "../pappermint-pink.png", 0.08, 0.08);
};
let pappermintRed = function () {
  return createRoundCandy(23, "../pappermint-red.png", 0.06, 0.06);
};
